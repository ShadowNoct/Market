const VERSION = "v4.8 Skip Day Test";
...
function home() {
  ...
  setForm("StoneHaven Exchange",
    ...
    button("paper", "Skip Day (Test)", "Temporary preview button: reroll daily prices", "rollDailyMarket")
  );
}
...
function handleClick(event) {
  ...
  const actions = { home, market, portfolio, news, help, stockPage, confirmTrade, doTrade, switchPlayer, rollDailyMarket };
